...
import net.stickia.carpethex.casting.patterns.math.OpSignum;
import net.stickia.carpethex.casting.patterns.spells.OpCongrats;
...
public class CarpetHexPatternRegistry {
